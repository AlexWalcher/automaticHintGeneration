...
def prune_and_ordered_dict(dictionary, n):
  ...
  bad_categories_list = ['Living_people', 'Living people', '_births', 'births', '_deaths', 'deaths', 'Good_articles', 'Good articles', 'Members','19th', 'Capitals in Europe', 'state capitals', 'Spoken articles', 'Spoken_articles', 'People_appearing_on_C-SPAN', 'People appearing on C-SPAN','American_billionaires', 'articles', 'Featured_articles', 'Time_Person_of_the_Year', 'Time Person of the Year']
  print(dictionary)
